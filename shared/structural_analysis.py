...
class SectionDatabase:
    ...
    I_BEAMS = {
        "10": {"h": 100, "b": 55, "tw": 4.5, "tf": 7.2, "A_cm2": 12.0, "Ix_cm4": 198, "Iy_cm4": 17.9, "Wx_cm3": 39.7, "Wy_cm3": 6.49, "ix_cm": 4.07, "iy_cm": 1.22},
        "12": {"h": 120, "b": 64, "tw": 4.8, "tf": 7.3, "A_cm2": 14.7, "Ix_cm4": 351, "Iy_cm4": 28.0, "Wx_cm3": 58.4, "Wy_cm3": 8.75, "ix_cm": 4.88, "iy_cm": 1.38},
        "14": {"h": 140, "b": 73, "tw": 4.9, "tf": 7.5, "A_cm2": 17.4, "Ix_cm4": 572, "Iy_cm4": 42.8, "Wx_cm3": 81.7, "Wy_cm3": 11.7, "ix_cm": 5.73, "iy_cm": 1.57},
        "16": {"h": 160, "b": 81, "tw": 5.0, "tf": 7.8, "A_cm2": 20.2, "Ix_cm4": 873, "Iy_cm4": 58.5, "Wx_cm3": 109, "Wy_cm3": 14.4, "ix_cm": 6.57, "iy_cm": 1.70},
        "18": {"h": 180, "b": 90, "tw": 5.1, "tf": 8.1, "A_cm2": 23.0, "Ix_cm4": 1250, "Iy_cm4": 80.6, "Wx_cm3": 139, "Wy_cm3": 17.9, "ix_cm": 7.38, "iy_cm": 1.87},
        "20": {"h": 200, "b": 100, "tw": 5.2, "tf": 8.4, "A_cm2": 26.1, "Ix_cm4": 1740, "Iy_cm4": 110, "Wx_cm3": 174, "Wy_cm3": 22.0, "ix_cm": 8.17, "iy_cm": 2.06},
        "24": {"h": 240, "b": 115, "tw": 5.6, "tf": 9.3, "A_cm2": 32.4, "Ix_cm4": 3270, "Iy_cm4": 183, "Wx_cm3": 273, "Wy_cm3": 31.9, "ix_cm": 10.05, "iy_cm": 2.38},
        "27": {"h": 270, "b": 125, "tw": 6.0, "tf": 10.0, "A_cm2": 38.5, "Ix_cm4": 5010, "Iy_cm4": 264, "Wx_cm3": 371, "Wy_cm3": 42.2, "ix_cm": 11.41, "iy_cm": 2.62},
        "30": {"h": 300, "b": 135, "tw": 6.5, "tf": 10.8, "A_cm2": 45.0, "Ix_cm4": 7310, "Iy_cm4": 374, "Wx_cm3": 487, "Wy_cm3": 55.4, "ix_cm": 12.74, "iy_cm": 2.88},
        "36": {"h": 360, "b": 165, "tw": 7.5, "tf": 12.6, "A_cm2": 60.5, "Ix_cm4": 13500, "Iy_cm4": 789, "Wx_cm3": 750, "Wy_cm3": 95.7, "ix_cm": 14.94, "iy_cm": 3.61},
        "40": {"h": 400, "b": 155, "tw": 8.0, "tf": 13.5, "A_cm2": 66.8, "Ix_cm4": 17900, "Iy_cm4": 744, "Wx_cm3": 895, "Wy_cm3": 96.0, "ix_cm": 16.36, "iy_cm": 3.33},
        "45": {"h": 450, "b": 170, "tw": 9.0, "tf": 15.0, "A_cm2": 82.0, "Ix_cm4": 27800, "Iy_cm4": 1120, "Wx_cm3": 1236, "Wy_cm3": 132, "ix_cm": 18.40, "iy_cm": 3.70},
        "50": {"h": 500, "b": 180, "tw": 10.0, "tf": 16.0, "A_cm2": 97.0, "Ix_cm4": 40900, "Iy_cm4": 1510, "Wx_cm3": 1636, "Wy_cm3": 168, "ix_cm": 20.55, "iy_cm": 3.94},
        "55": {"h": 550, "b": 190, "tw": 11.0, "tf": 17.5, "A_cm2": 115, "Ix_cm4": 58500, "Iy_cm4": 2070, "Wx_cm3": 2127, "Wy_cm3": 218, "ix_cm": 22.53, "iy_cm": 4.25},
        "60": {"h": 600, "b": 200, "tw": 12.0, "tf": 19.0, "A_cm2": 135, "Ix_cm4": 80800, "Iy_cm4": 2770, "Wx_cm3": 2693, "Wy_cm3": 277, "ix_cm": 24.50, "iy_cm": 4.54},
    }
    
    # Швеллеры (ГОСТ 8240)
    CHANNELS = {
        "8":  {"h": 80,  "b": 40, "tw": 4.5, "tf": 7.0, "A_cm2": 8.98, "Ix_cm4": 77.8, "Iy_cm4": 10.4, "Wx_cm3": 19.5, "Wy_cm3": 4.48},
        "10": {"h": 100, "b": 46, "tw": 4.5, "tf": 7.5, "A_cm2": 11.2, "Ix_cm4": 150, "Iy_cm4": 18.2, "Wx_cm3": 30.0, "Wy_cm3": 6.50},
        "12": {"h": 120, "b": 52, "tw": 4.8, "tf": 7.8, "A_cm2": 13.5, "Ix_cm4": 260, "Iy_cm4": 29.5, "Wx_cm3": 43.3, "Wy_cm3": 9.00},
        "14": {"h": 140, "b": 58, "tw": 5.0, "tf": 8.2, "A_cm2": 15.8, "Ix_cm4": 410, "Iy_cm4": 44.7, "Wx_cm3": 58.6, "Wy_cm3": 12.0},
        "16": {"h": 160, "b": 64, "tw": 5.5, "tf": 8.7, "A_cm2": 18.4, "Ix_cm4": 618, "Iy_cm4": 64.3, "Wx_cm3": 77.2, "Wy_cm3": 15.5},
        "18": {"h": 180, "b": 70, "tw": 5.5, "tf": 9.0, "A_cm2": 20.7, "Ix_cm4": 886, "Iy_cm4": 88.2, "Wx_cm3": 98.5, "Wy_cm3": 19.7},
        "20": {"h": 200, "b": 76, "tw": 6.0, "tf": 9.5, "A_cm2": 23.6, "Ix_cm4": 1240, "Iy_cm4": 118, "Wx_cm3": 124, "Wy_cm3": 24.6},
        "24": {"h": 240, "b": 82, "tw": 6.5, "tf": 10.5, "A_cm2": 28.8, "Ix_cm4": 2220, "Iy_cm4": 164, "Wx_cm3": 185, "Wy_cm3": 33.2},
        "30": {"h": 300, "b": 90, "tw": 7.5, "tf": 12.0, "A_cm2": 38.4, "Ix_cm4": 4430, "Iy_cm4": 254, "Wx_cm3": 295, "Wy_cm3": 47.5},
    }
    
    # Трубы прямоугольные (ГОСТ 8645) — выборочно
    RECT_TUBES = {
        "50x25x3":   {"h": 50,  "b": 25,  "t": 3, "A_cm2": 4.08, "Ix_cm4": 16.5, "Iy_cm4": 5.76, "Wx_cm3": 6.60, "Wy_cm3": 4.61},
        "60x40x3":   {"h": 60,  "b": 40,  "t": 3, "A_cm2": 5.28, "Ix_cm4": 34.3, "Iy_cm4": 17.2, "Wx_cm3": 11.4, "Wy_cm3": 8.62},
        "80x40x3":   {"h": 80,  "b": 40,  "t": 3, "A_cm2": 6.48, "Ix_cm4": 68.6, "Iy_cm4": 24.1, "Wx_cm3": 17.2, "Wy_cm3": 12.0},
        "100x50x4":  {"h": 100, "b": 50,  "t": 4, "A_cm2": 10.9, "Ix_cm4": 184,  "Iy_cm4": 63.1, "Wx_cm3": 36.8, "Wy_cm3": 25.2},
        "120x60x4":  {"h": 120, "b": 60,  "t": 4, "A_cm2": 13.3, "Ix_cm4": 325,  "Iy_cm4": 108,  "Wx_cm3": 54.2, "Wy_cm3": 36.1},
        "140x80x5":  {"h": 140, "b": 80,  "t": 5, "A_cm2": 20.5, "Ix_cm4": 675,  "Iy_cm4": 294,  "Wx_cm3": 96.4, "Wy_cm3": 73.5},
        "160x80x5":  {"h": 160, "b": 80,  "t": 5, "A_cm2": 22.5, "Ix_cm4": 925,  "Iy_cm4": 317,  "Wx_cm3": 115.6,"Wy_cm3": 79.3},
        "180x100x6": {"h": 180, "b": 100, "t": 6, "A_cm2": 31.3, "Ix_cm4": 1620, "Iy_cm4": 648,  "Wx_cm3": 180,  "Wy_cm3": 129.6},
        "200x100x6": {"h": 200, "b": 100, "t": 6, "A_cm2": 33.3, "Ix_cm4": 2120, "Iy_cm4": 696,  "Wx_cm3": 212,  "Wy_cm3": 139},
    }
    
    @classmethod
    def get_i_beam(cls, number: str) -> Optional[Dict]:
        """Получить параметры двутавра по номеру."""
        return cls.I_BEAMS.get(str(number))
    
    @classmethod
    def get_channel(cls, number: str) -> Optional[Dict]:
        """Получить параметры швеллера по номеру."""
        return cls.CHANNELS.get(str(number))
    
    @classmethod
    def get_rect_tube(cls, designation: str) -> Optional[Dict]:
    ...
    def calc_rect_section(cls, b: float, h: float) -> Dict[str, float]:
        ...
        iy = b / math.sqrt(12)
        return {
            "A_m2": round(A, 6), "Ix_m4": round(Ix, 8), "Iy_m4": round(Iy, 8),
            "Wx_m3": round(Wx, 7), "Wy_m3": round(Wy, 7),
            "ix_m": round(ix, 4), "iy_m": round(iy, 4),
        }
    ...
    def calc_circular_section(cls, r: float) -> Dict[str, float]:
        ...
        i = r / 2
        return {
            "A_m2": round(A, 6), "I_m4": round(I, 8),
            "W_m3": round(W, 7), "i_m": round(i, 4),
        }
...
class FEMSolver:
    ...
    def assemble_global_stiffness(elements: List[Dict], n_nodes: int, dof_per_node: int = 3) -> 'np.ndarray':
        ...
        for elem in elements:
            ke = FEMSolver.beam_element_stiffness(
                elem['E'], elem['A'], elem['I'], elem['L']
            )
            nodes = elem['nodes']
    ...
    def apply_boundary_conditions(K: 'np.ndarray', F: 'np.ndarray', 
                                   fixed_dofs: List[int]) -> Tuple['np.ndarray', 'np.ndarray', List[int]]:
        """
    ...
    @staticmethod
    def recover_full_displacements(u_red: 'np.ndarray', free_dofs: List[int], 
...
class LoadCombiner:
    ...
    @staticmethod
    def basic_combination(dead_kN: float, live_kN: float, snow_kN: float = 0, 
                          wind_kN: float = 0) -> Dict:
        """
        ...
        N_total = (gf_dead * dead_kN + 
                   gf_live * live_kN + 
                   gf_snow * snow_kN + 
                   gf_wind * psi_0["wind"] * wind_kN)
    ...
    @staticmethod
    def seismic_combination(dead_kN: float, live_kN: float, 
                             seismic_kN: float) -> Dict:
        """
    ...
    @staticmethod
    def pattern_loading(dead_kN: float, live_kN: float, 
                        span_count: int = 3) -> List[Dict]:
        """
...
class MemberChecker:
    ...
    @staticmethod
    def steel_beam_bending(W_x_m3: float, f_y_MPa: float, 
                           gamma_c: float = 1.0) -> Dict:
        """
    ...
    @staticmethod
    def steel_beam_shear(A_web_m2: float, f_y_MPa: float, 
                         gamma_c: float = 1.0) -> Dict:
        """
    ...
    @staticmethod
    def steel_column_axial(A_m2: float, f_y_MPa: float, 
                           chi: float, gamma_c: float = 1.0) -> Dict:
        """
    ...
    @staticmethod
    def deflection_check(L_m: float, delta_actual_m: float, 
                          limit_ratio: int = 250) -> Dict:
        """
    ...
    @staticmethod
    def rc_beam_flexure(b_m: float, h_m: float, d_m: float, 
                         concrete_class: str, rebar_class: str,
                         M_kNm: float) -> Dict:
        """
        ...
        A_s_min = max(0.001 * b_m * 1000 * h_m * 1000,
                      0.06 * f_b * b_m * 1000 * h_m * 1000 / f_y)
    ...
    @staticmethod
    def crack_width_check(A_s_mm2: float, b_m: float, h_m: float,
                           d_m: float, M_kNm: float, concrete_class: str,
                           rebar_class: str, exposure_class: str = "XC1") -> Dict:
        """
        ...
        w_max_table = {
            "XC1": 0.4, "XC2": 0.3, "XC3": 0.3,
            "XC4": 0.2, "XD1": 0.2, "XD2": 0.2,
            "XS1": 0.2, "XS2": 0.2, "XS3": 0.2,
            "XA1": 0.2, "XA2": 0.2, "XA3": 0.2,
        }
...
class DynamicsAnalyzer:
    ...
    @staticmethod
    def seismic_force(mass_kg: float, K1: float = 0.5, 
                       beta: float = 1.0, I: float = 1.0) -> Dict:
        """
    ...
    @staticmethod
    def response_spectrum(T_s: float, soil_type: str = "II", 
                           seismic_zone: int = 7) -> Dict:
        """
...
class FoundationAnalyzer:
    ...
    @staticmethod
    def bearing_capacity_sand(soil_type: str, depth_m: float, 
                               width_m: float) -> Dict:
        """
    ...
    @staticmethod
    def settlement_estimate(R_kPa: float, E0_MPa: float, 
                             B_m: float, load_kPa: float) -> Dict:
        """
    ...
    @staticmethod
    def pile_capacity(diameter_m: float, length_m: float, 
                       soil_type: str, pile_type: str = "bored") -> Dict:
        """
...
class StabilityAnalyzer:
    ...
    @staticmethod
    def lateral_torsional_buckling(E_MPa: float, G_MPa: float,
                                     Iy_m4: float, It_m4: float,
                                     Iw_m6: float, L_m: float,
                                     h_m: float) -> Dict:
        """
    ...
    @staticmethod
    def p_delta_effect(N_kN: float, delta_m: float, 
...
class StructuralEngine:
    ...
    def full_building_analysis(self, params: Dict) -> Dict:
        ...
        results["checks"]["load_combinations"] = self.loads.basic_combination(
            dead, live, snow, wind
        )
        ...
        results["checks"]["deflection"] = self.checker.deflection_check(
            L, delta, limit_ratio=250
        )
        ...
        results["checks"]["foundation"] = self.foundation.bearing_capacity_sand(
            soil, foundation_depth, width
        )
    ...
    def get_section(self, section_type: str, designation: str) -> Optional[Dict]:
