...
KNOWN_BUILDING_TYPES = {
    "house", "office", "cottage", "villa", "apartment", "townhouse",
    "hotel", "hostel", "barn", "garage", "gazebo", "greenhouse",
    "bathhouse", "pool", "fence", "gate", "log_cabin", "izba",
    "chicken_coop", "carport", "warehouse", "restaurant", "school",
    "hospital", "shop", "mall", "factory", "church", "mosque",
    "stadium", "bridge", "tower", "skyscraper", "duplex",
}
KNOWN_ROOM_TYPES = {
    "bedroom", "kitchen", "living", "bathroom", "children", "study",
    "dining", "hallway", "nursery", "laundry", "pantry", "attic",
    "basement", "garage_interior", "sauna", "pool_interior",
    "office_interior", "lobby", "corridor", "wc", "dressing",
}
KNOWN_STYLES = {
    "modern", "classic", "loft", "scandinavian", "minimalist", "hitech",
    "japanese", "medieval", "rustic", "colonial", "art_deco", "baroque",
    "empire", "provence", "tropical", "industrial", "bohemian", "gothic",
    "constructivist", "futuristic", "eco", "arabic", "chinese", "indian",
}
KNOWN_MATERIALS = {
    "brick", "wood", "glass", "stone", "concrete", "plaster", "metal",
    "log", "straw", "adobe", "marble", "granite", "slate", "ceramic",
    "steel", "aluminum", "copper", "zinc", "titanium", "composite",
    "sip_panel", "lstk", "foam_block", "gas_silicate", "timber_frame",
}
KNOWN_ROOF_TYPES = {
    "gabled", "flat", "hip", "mansard", "shed", "dome", "asymmetric",
    "green", "butterfly", "curved", "gambrel", "saltbox", "bonnet",
}
KNOWN_FEATURES = {
    "balcony", "terrace", "garage", "pool", "garden", "chimney",
    "skylight", "basement", "attic", "veranda", "porch", "deck",
    "pergola", "fountain", "pond", "greenhouse", "workshop",
    "wine_cellar", "home_theater", "gym", "spa", "sauna",
}
